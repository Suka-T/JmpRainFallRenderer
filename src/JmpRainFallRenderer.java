...
public class JmpRainFallRenderer extends JMidiPlugin implements IPlayerListener, ISupportExtensionConstraints {
    ...
    public static JmpRainFallRendererWindow MainWindow = null;
    ...
    public void initialize() {
        ...
        if (SwingUtilities.isEventDispatchThread()) {
            MainWindow = new JmpRainFallRendererWindow();
            MainWindow.init();
        }
        else {
            try {
